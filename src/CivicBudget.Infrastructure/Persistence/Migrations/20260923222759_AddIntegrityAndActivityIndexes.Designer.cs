...
namespace CivicBudget.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923222759_AddIntegrityAndActivityIndexes")]
    partial class AddIntegrityAndActivityIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CivicBudget.Infrastructure.Identity.UserAvatar", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CivicBudget.Infrastructure.Persistence.GovernmentLogo", b =>
                {
                    b.Property<Guid>("GovernmentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GovernmentLogos", (string)null);
                });
            ...
            modelBuilder.Entity("CivicBudget.Infrastructure.Identity.UserAvatar", b =>
                {
                    b.HasOne("CivicBudget.Infrastructure.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("CivicBudget.Infrastructure.Identity.UserAvatar", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CivicBudget.Infrastructure.Persistence.GovernmentLogo", b =>
                {
                    b.HasOne("CivicBudget.Domain.Governments.Government", null)
                        .WithOne()
                        .HasForeignKey("CivicBudget.Infrastructure.Persistence.GovernmentLogo", "GovernmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
