...
/// <summary>
/// Redirect helper for the statically rendered Account pages (adapted from the ASP.NET Core Identity
/// template). Status messages survive the redirect in a short-lived cookie because a static page
/// has no component state to carry them in.
/// </summary>
