...
public static class Policies
{
    ...
    /// <summary>Maintain funds, departments, accounts, fiscal years. Admin, Administrator or Fiscal Officer.</summary>
    ...
    /// <summary>Propose, return, adopt, and start amendments. Administrator or Fiscal Officer.</summary>
    ...
    /// <summary>See the audit trail. Admin, Fiscal Officer, department user.</summary>
